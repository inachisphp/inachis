...
use Inachis\Controller\Page\Setting\Discovery\RobotsTxtWebController;
...
final class RobotsTxtWebControllerTest extends TestCase
{
    public function testCanBeInstantiated(): void
    {
        ...
        $instance = new RobotsTxtWebController($params, $pageViewFactory);

        self::assertInstanceOf(
            RobotsTxtWebController::class,
            $instance,
        );
    }
}
